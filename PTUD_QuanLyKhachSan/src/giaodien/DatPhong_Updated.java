 ...
 * @author Huynguyen
 */
public class DatPhong_Updated extends javax.swing.JDialog {
	...
	public DatPhong_Updated(List<String> dsTenPhong) {
...
//		}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(DatPhong_Updated.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
