...
public class TrangChu extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		lblTenNhanVienHeader = new javax.swing.JLabel();
...
//		TTK merge
		dateNgaySinhNhanVien.setForeground(new Color(255, 203, 119));
		dateNgaySinhNhanVien.setTextRefernce(txtNgaySinhNhanVien);

		dateNgayVaoLam.setForeground(new Color(255, 203, 119));
		...
		dateNgayKetThucKM.setForeground(new Color(255, 203, 119));
		dateNgayKetThucKM.setTextRefernce(txtNgayKetThucKhuyenMai);

		dateNgaySinhKhachHang.setForeground(new Color(255, 203, 119));
...
//		lblTrangThaiTrangChu9 = new javax.swing.JLabel();
		...
		for (int i = 0; i < 35; i++) {
			try {
				phongTrangChu
						.add((javax.swing.JPanel) getClass().getDeclaredField("phongTrangChu" + (i + 1)).get(this));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		...
		for (int i = 0; i < 35; i++) {
			try {
				tenPhongTrangChu.add(
						(javax.swing.JLabel) getClass().getDeclaredField("lblTenPhongTrangChu" + (i + 1)).get(this));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		...
		for (int i = 0; i < 35; i++) {
			try {
				loaiPhongTrangChu.add(
						(javax.swing.JLabel) getClass().getDeclaredField("lblLoaiPhongTrangChu" + (i + 1)).get(this));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		...
		for (int i = 0; i < 35; i++) {
			try {
				trangThaiPhongTrangChu.add(
						(javax.swing.JLabel) getClass().getDeclaredField("lblTrangThaiTrangChu" + (i + 1)).get(this));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		...
		for (int i = 0; i < 35; i++) {
			try {
				phongQuanLy.add((javax.swing.JPanel) getClass().getDeclaredField("phongQuanLy" + (i + 1)).get(this));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		...
		for (int i = 0; i < 35; i++) {
			try {
				loaiPhongQuanLy
						.add((javax.swing.JLabel) getClass().getDeclaredField("lblLoaiPhongQL" + (i + 1)).get(this));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		...
		for (int i = 0; i < 35; i++) {
			try {
				tenPhongQuanLy
						.add((javax.swing.JLabel) getClass().getDeclaredField("lblTenPhongQL" + (i + 1)).get(this));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		...
		for (int i = 0; i < 35; i++) {
			try {
				trangThaiPhongQuanLy
						.add((javax.swing.JLabel) getClass().getDeclaredField("lblTrangThaiQL" + (i + 1)).get(this));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		...
		for (int i = 0; i < 35; i++) {
			try {
				checkBoxPhongQuanLy.add(
						(javax.swing.JCheckBox) getClass().getDeclaredField("checkBoxPhongQL" + (i + 1)).get(this));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		...
		lblTenNhanVienHeader.setFont(new Font("Segoe UI", Font.BOLD, 18)); // NOI18N
		lblTenNhanVienHeader.setText("Tên nhân viên");

		javax.swing.GroupLayout jPanel5Layout = new javax.swing.GroupLayout(jPanel5);
		jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING)
				.addGroup(jPanel5Layout.createSequentialGroup().addGap(19)
						.addComponent(lblTenNhanVienHeader, GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
						.addContainerGap()));
		jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(Alignment.TRAILING).addGroup(
				jPanel5Layout.createSequentialGroup().addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(lblTenNhanVienHeader).addContainerGap()));
		...
		pnLayOutTrangChuLayout.setHorizontalGroup(
				pnLayOutTrangChuLayout.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
						pnLayOutTrangChuLayout.createSequentialGroup()
								.addComponent(pnBody1, GroupLayout.PREFERRED_SIZE, 1226, GroupLayout.PREFERRED_SIZE)
								.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		pnLayOutTrangChuLayout.setVerticalGroup(
				pnLayOutTrangChuLayout.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
						pnLayOutTrangChuLayout.createSequentialGroup()
								.addComponent(pnBody1, GroupLayout.PREFERRED_SIZE, 704, GroupLayout.PREFERRED_SIZE)
								.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		funtionPanelLayout.setHorizontalGroup(funtionPanelLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(funtionPanelLayout.createSequentialGroup().addGap(66).addGroup(funtionPanelLayout
						...
						.addComponent(lbldate, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)).addGap(41)
						.addGroup(funtionPanelLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(radPhongTieuChuan)
								.addComponent(radPhongNangCao, GroupLayout.PREFERRED_SIZE, 146,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(radPhongThuongGia)
								.addComponent(radPhongCaoCap, GroupLayout.PREFERRED_SIZE, 146,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel2, GroupLayout.PREFERRED_SIZE, 266, GroupLayout.PREFERRED_SIZE))
						.addGap(40)
						.addGroup(funtionPanelLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(radPhongTrong, GroupLayout.PREFERRED_SIZE, 141,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel1)
								.addComponent(btnTimTheoDieuKien, GroupLayout.PREFERRED_SIZE, 102,
										GroupLayout.PREFERRED_SIZE)
								.addGroup(funtionPanelLayout.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(radPhongDangThue, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
												GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(radPhongDaDat, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 141,
												Short.MAX_VALUE)))
						.addGap(38)
						.addGroup(funtionPanelLayout.createParallelGroup(Alignment.LEADING, false)
								.addComponent(btnTraPhong, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(btnDoiPhong, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(btnHuyDatPhong, GroupLayout.DEFAULT_SIZE, 143, Short.MAX_VALUE)
								.addComponent(btnDatPhong, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(btnResetTrangThai, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap(219, Short.MAX_VALUE)));
		funtionPanelLayout.setVerticalGroup(funtionPanelLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(funtionPanelLayout.createSequentialGroup().addContainerGap()
						...
						.addGroup(
								funtionPanelLayout.createParallelGroup(Alignment.BASELINE).addComponent(lblcurrentdate)
										.addComponent(radPhongTieuChuan, GroupLayout.PREFERRED_SIZE, 25,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(radPhongTrong).addComponent(btnHuyDatPhong))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(funtionPanelLayout.createParallelGroup(Alignment.BASELINE).addComponent(lbltime)
								.addComponent(radPhongNangCao).addComponent(radPhongDangThue).addComponent(btnDoiPhong))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(funtionPanelLayout
								.createParallelGroup(Alignment.BASELINE).addComponent(radPhongCaoCap)
								.addComponent(radPhongDaDat).addComponent(lblcurrentTime).addComponent(btnTraPhong))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(funtionPanelLayout.createParallelGroup(Alignment.BASELINE)
								.addComponent(radPhongThuongGia).addComponent(btnResetTrangThai,
		...
		jLabel24.setText("Giá trị khuyến mãi");
		...
		btnNgungKhuyenMai.setText("Cho ngừng khuyến mãi");
		...
		jPanel16Layout.setHorizontalGroup(jPanel16Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel16Layout
				.createSequentialGroup()
				.addGroup(jPanel16Layout.createParallelGroup(Alignment.TRAILING).addGroup(jPanel16Layout
						.createSequentialGroup().addGap(56)
						.addGroup(jPanel16Layout.createParallelGroup(Alignment.LEADING).addComponent(jLabel20,
								GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
								.addComponent(jLabel19, GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(jPanel16Layout.createParallelGroup(Alignment.TRAILING, false).addGroup(jPanel16Layout
								.createSequentialGroup()
								.addComponent(txtNgayBatDauKhuyenMai, GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(btnThoiGianBatDauKhuyenMai, GroupLayout.PREFERRED_SIZE, 24,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED))
								.addComponent(txtMaKhuyenMai, Alignment.LEADING))
						.addGap(70)
						.addGroup(jPanel16Layout.createParallelGroup(Alignment.LEADING)
								.addComponent(jLabel23, GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
								.addComponent(jLabel22, GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(jPanel16Layout.createParallelGroup(Alignment.LEADING, false)
								.addGroup(jPanel16Layout.createSequentialGroup()
										.addComponent(txtNgayKetThucKhuyenMai, GroupLayout.PREFERRED_SIZE, 159,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addComponent(btnThoiGianKetThucKhuyenMai, GroupLayout.PREFERRED_SIZE, 24,
												GroupLayout.PREFERRED_SIZE))
								.addComponent(txtTenKhuyenMai))
						.addPreferredGap(ComponentPlacement.RELATED, 45, Short.MAX_VALUE)
						.addGroup(jPanel16Layout.createParallelGroup(Alignment.LEADING, false)
								.addComponent(jLabel24, GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE).addComponent(
										jLabel25, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(jPanel16Layout.createParallelGroup(Alignment.LEADING)
								.addComponent(txtGiaTriKhuyenMai, GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE)
								.addComponent(cbxDieuKienApDungKhuyenMai, 0, 188, Short.MAX_VALUE)))
						.addGroup(jPanel16Layout.createSequentialGroup().addGap(0, 621, Short.MAX_VALUE)
								.addComponent(btnXoaTrangKhuyenMai).addGap(18).addComponent(btnThemKhuyenMai).addGap(18)
								.addComponent(btnCapNhapKhuyenMai).addGap(18).addComponent(btnNgungKhuyenMai)))
				.addGap(65)));
		jPanel16Layout.setVerticalGroup(jPanel16Layout.createParallelGroup(Alignment.LEADING)
				.addGroup(jPanel16Layout.createSequentialGroup().addGap(19)
						.addGroup(jPanel16Layout.createParallelGroup(Alignment.LEADING)
								.addGroup(jPanel16Layout.createSequentialGroup()
										.addGroup(jPanel16Layout.createParallelGroup(Alignment.BASELINE)
												.addComponent(jLabel22, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(
														txtTenKhuyenMai, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addGap(18)
										.addGroup(jPanel16Layout.createParallelGroup(Alignment.TRAILING)
												.addGroup(jPanel16Layout.createParallelGroup(Alignment.BASELINE)
														...
														.addComponent(txtNgayKetThucKhuyenMai,
																...
																GroupLayout.PREFERRED_SIZE))
												.addComponent(btnThoiGianKetThucKhuyenMai, GroupLayout.PREFERRED_SIZE,
														22, GroupLayout.PREFERRED_SIZE)))
								.addGroup(jPanel16Layout.createSequentialGroup()
										.addGroup(jPanel16Layout.createParallelGroup(Alignment.BASELINE)
												.addComponent(jLabel24, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(txtGiaTriKhuyenMai, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addGap(21)
										.addGroup(jPanel16Layout.createParallelGroup(Alignment.BASELINE)
												.addComponent(jLabel25, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(cbxDieuKienApDungKhuyenMai, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
								.addGroup(jPanel16Layout.createSequentialGroup()
										.addGroup(jPanel16Layout.createParallelGroup(Alignment.BASELINE)
												.addComponent(jLabel19, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(
														txtMaKhuyenMai, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addGap(18)
										.addGroup(jPanel16Layout.createParallelGroup(Alignment.TRAILING)
												.addGroup(jPanel16Layout.createParallelGroup(Alignment.BASELINE)
														...
														.addComponent(txtNgayBatDauKhuyenMai,
																GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
																GroupLayout.PREFERRED_SIZE))
												.addComponent(btnThoiGianBatDauKhuyenMai, GroupLayout.PREFERRED_SIZE,
														22, GroupLayout.PREFERRED_SIZE))))
						.addPreferredGap(ComponentPlacement.UNRELATED, 14, Short.MAX_VALUE)
						.addGroup(jPanel16Layout.createParallelGroup(Alignment.BASELINE).addComponent(btnNgungKhuyenMai)
								.addComponent(btnCapNhapKhuyenMai).addComponent(btnThemKhuyenMai)
...
//    TTK
	...
	private javax.swing.JLabel lblTenNhanVienHeader;
	...
	private ArrayList<JPanel> phongTrangChu;
...
//                         FORMAT get date from table chưa làm được
						...
						String ngaySinhStr = String.format("%02d-%02d-%d", ngaySinh.getDayOfMonth(),
								ngaySinh.getMonthValue(), ngaySinh.getYear());
