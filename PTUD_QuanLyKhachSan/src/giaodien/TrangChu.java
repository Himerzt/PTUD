...
public class TrangChu extends javax.swing.JFrame {
	...
	public TrangChu(String tenDangNhap) throws Exception {
		...
		pnedUngDung.addTab("Quản lý khuyến mãi", new KhuyenMai());
		pnedUngDung.addTab("Quản lý khách hàng", new KhachHang());
	...
	public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    TrangChu trangChu = new TrangChu(new String("admin"));
