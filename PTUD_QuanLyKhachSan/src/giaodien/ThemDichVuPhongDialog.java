 ...
 * @author Huynguyen
 */
public class ThemDichVuPhongDialog extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemDichVuPhongDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
