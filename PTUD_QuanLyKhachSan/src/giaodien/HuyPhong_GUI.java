 ...
 * @author Huynguyen
 */
public class HuyPhong_GUI extends javax.swing.JDialog {
	...
	public HuyPhong_GUI(List<String> dsTenPhong) {
...
//		}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(HuyPhong_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
