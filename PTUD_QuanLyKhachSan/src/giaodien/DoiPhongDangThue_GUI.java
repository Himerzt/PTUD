...
public class DoiPhongDangThue_GUI extends javax.swing.JDialog {
	...
	public void btnDoiPhongActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (listLSDP.demLichSuDoiPhongTheoMaPhongCu(maPhongHienTai) == 1) {
			...
			lichSuDoiPhong = new LichSuDoiPhong(maKhachHang, tenKhachHang, maPhongHienTai, phong.getMaPhong(),
					LocalDate.now(), txtTenKhachHang1.getText());
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(DoiPhongDangThue_GUI.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
