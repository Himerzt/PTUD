 ...
 * @author Huynguyen
 */
public class TrangChu_Updated extends javax.swing.JFrame {
    ...
    public TrangChu_Updated() throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrangChu_Updated.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    TrangChu_Updated trangChu = new TrangChu_Updated();
