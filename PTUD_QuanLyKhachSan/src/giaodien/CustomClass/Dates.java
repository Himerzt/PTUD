...
import giaodien.custom2.Button;
import giaodien.CustomClass.Event;
import giaodien.CustomClass.SelectedDate;
...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new giaodien.custom2.Button();
        cmdTu = new giaodien.custom2.Button();
        cmdWe = new giaodien.custom2.Button();
        cmdTh = new giaodien.custom2.Button();
        cmdFr = new giaodien.custom2.Button();
        cmdSa = new giaodien.custom2.Button();
        cmdSu = new giaodien.custom2.Button();
        cmd1 = new giaodien.custom2.Button();
        cmd2 = new giaodien.custom2.Button();
        cmd3 = new giaodien.custom2.Button();
        cmd4 = new giaodien.custom2.Button();
        cmd5 = new giaodien.custom2.Button();
        cmd6 = new giaodien.custom2.Button();
        cmd7 = new giaodien.custom2.Button();
        cmd8 = new giaodien.custom2.Button();
        cmd9 = new giaodien.custom2.Button();
        cmd10 = new giaodien.custom2.Button();
        cmd11 = new giaodien.custom2.Button();
        cmd12 = new giaodien.custom2.Button();
        cmd13 = new giaodien.custom2.Button();
        cmd14 = new giaodien.custom2.Button();
        cmd15 = new giaodien.custom2.Button();
        cmd16 = new giaodien.custom2.Button();
        cmd17 = new giaodien.custom2.Button();
        cmd18 = new giaodien.custom2.Button();
        cmd19 = new giaodien.custom2.Button();
        cmd20 = new giaodien.custom2.Button();
        cmd21 = new giaodien.custom2.Button();
        cmd22 = new giaodien.custom2.Button();
        cmd23 = new giaodien.custom2.Button();
        cmd24 = new giaodien.custom2.Button();
        cmd25 = new giaodien.custom2.Button();
        cmd26 = new giaodien.custom2.Button();
        cmd27 = new giaodien.custom2.Button();
        cmd28 = new giaodien.custom2.Button();
        cmd29 = new giaodien.custom2.Button();
        cmd30 = new giaodien.custom2.Button();
        cmd31 = new giaodien.custom2.Button();
        cmd32 = new giaodien.custom2.Button();
        cmd33 = new giaodien.custom2.Button();
        cmd34 = new giaodien.custom2.Button();
        cmd35 = new giaodien.custom2.Button();
        cmd36 = new giaodien.custom2.Button();
        cmd37 = new giaodien.custom2.Button();
        cmd38 = new giaodien.custom2.Button();
        cmd39 = new giaodien.custom2.Button();
        cmd40 = new giaodien.custom2.Button();
        cmd41 = new giaodien.custom2.Button();
        cmd42 = new giaodien.custom2.Button();
    ...
    private giaodien.custom2.Button cmd1;
    private giaodien.custom2.Button cmd10;
    private giaodien.custom2.Button cmd11;
    private giaodien.custom2.Button cmd12;
    private giaodien.custom2.Button cmd13;
    private giaodien.custom2.Button cmd14;
    private giaodien.custom2.Button cmd15;
    private giaodien.custom2.Button cmd16;
    private giaodien.custom2.Button cmd17;
    private giaodien.custom2.Button cmd18;
    private giaodien.custom2.Button cmd19;
    private giaodien.custom2.Button cmd2;
    private giaodien.custom2.Button cmd20;
    private giaodien.custom2.Button cmd21;
    private giaodien.custom2.Button cmd22;
    private giaodien.custom2.Button cmd23;
    private giaodien.custom2.Button cmd24;
    private giaodien.custom2.Button cmd25;
    private giaodien.custom2.Button cmd26;
    private giaodien.custom2.Button cmd27;
    private giaodien.custom2.Button cmd28;
    private giaodien.custom2.Button cmd29;
    private giaodien.custom2.Button cmd3;
    private giaodien.custom2.Button cmd30;
    private giaodien.custom2.Button cmd31;
    private giaodien.custom2.Button cmd32;
    private giaodien.custom2.Button cmd33;
    private giaodien.custom2.Button cmd34;
    private giaodien.custom2.Button cmd35;
    private giaodien.custom2.Button cmd36;
    private giaodien.custom2.Button cmd37;
    private giaodien.custom2.Button cmd38;
    private giaodien.custom2.Button cmd39;
    private giaodien.custom2.Button cmd4;
    private giaodien.custom2.Button cmd40;
    private giaodien.custom2.Button cmd41;
    private giaodien.custom2.Button cmd42;
    private giaodien.custom2.Button cmd5;
    private giaodien.custom2.Button cmd6;
    private giaodien.custom2.Button cmd7;
    private giaodien.custom2.Button cmd8;
    private giaodien.custom2.Button cmd9;
    private giaodien.custom2.Button cmdFr;
    private giaodien.custom2.Button cmdMo;
    private giaodien.custom2.Button cmdSa;
    private giaodien.custom2.Button cmdSu;
    private giaodien.custom2.Button cmdTh;
    private giaodien.custom2.Button cmdTu;
    private giaodien.custom2.Button cmdWe;
