...
import giaodien.CustomClass.Dates;
import giaodien.CustomClass.Event;
import giaodien.CustomClass.EventDateChooser;
import giaodien.CustomClass.Months;
import giaodien.CustomClass.SelectedAction;
import giaodien.CustomClass.SelectedDate;
import giaodien.CustomClass.Years;
...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new giaodien.custom2.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new giaodien.custom2.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new giaodien.custom2.Button();
        cmdPrevious = new giaodien.custom2.Button();
        slide = new giaodien.CustomClass.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgLogin/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgLogin/previous.png"))); // NOI18N
    ...
    private giaodien.custom2.Button cmdForward;
    private giaodien.custom2.Button cmdMonth;
    private giaodien.custom2.Button cmdPrevious;
    private giaodien.custom2.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private giaodien.CustomClass.Slider slide;
