...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new chooserDay.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new chooserDay.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new chooserDay.Button();
        cmdPrevious = new chooserDay.Button();
        slide = new chooserDay.Slider();
    ...
    private chooserDay.Button cmdForward;
    private chooserDay.Button cmdMonth;
    private chooserDay.Button cmdPrevious;
    private chooserDay.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private chooserDay.Slider slide;
