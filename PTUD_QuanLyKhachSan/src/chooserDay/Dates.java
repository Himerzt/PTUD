...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new chooserDay.Button();
        cmdTu = new chooserDay.Button();
        cmdWe = new chooserDay.Button();
        cmdTh = new chooserDay.Button();
        cmdFr = new chooserDay.Button();
        cmdSa = new chooserDay.Button();
        cmdSu = new chooserDay.Button();
        cmd1 = new chooserDay.Button();
        cmd2 = new chooserDay.Button();
        cmd3 = new chooserDay.Button();
        cmd4 = new chooserDay.Button();
        cmd5 = new chooserDay.Button();
        cmd6 = new chooserDay.Button();
        cmd7 = new chooserDay.Button();
        cmd8 = new chooserDay.Button();
        cmd9 = new chooserDay.Button();
        cmd10 = new chooserDay.Button();
        cmd11 = new chooserDay.Button();
        cmd12 = new chooserDay.Button();
        cmd13 = new chooserDay.Button();
        cmd14 = new chooserDay.Button();
        cmd15 = new chooserDay.Button();
        cmd16 = new chooserDay.Button();
        cmd17 = new chooserDay.Button();
        cmd18 = new chooserDay.Button();
        cmd19 = new chooserDay.Button();
        cmd20 = new chooserDay.Button();
        cmd21 = new chooserDay.Button();
        cmd22 = new chooserDay.Button();
        cmd23 = new chooserDay.Button();
        cmd24 = new chooserDay.Button();
        cmd25 = new chooserDay.Button();
        cmd26 = new chooserDay.Button();
        cmd27 = new chooserDay.Button();
        cmd28 = new chooserDay.Button();
        cmd29 = new chooserDay.Button();
        cmd30 = new chooserDay.Button();
        cmd31 = new chooserDay.Button();
        cmd32 = new chooserDay.Button();
        cmd33 = new chooserDay.Button();
        cmd34 = new chooserDay.Button();
        cmd35 = new chooserDay.Button();
        cmd36 = new chooserDay.Button();
        cmd37 = new chooserDay.Button();
        cmd38 = new chooserDay.Button();
        cmd39 = new chooserDay.Button();
        cmd40 = new chooserDay.Button();
        cmd41 = new chooserDay.Button();
        cmd42 = new chooserDay.Button();
    ...
    private chooserDay.Button cmd1;
    private chooserDay.Button cmd10;
    private chooserDay.Button cmd11;
    private chooserDay.Button cmd12;
    private chooserDay.Button cmd13;
    private chooserDay.Button cmd14;
    private chooserDay.Button cmd15;
    private chooserDay.Button cmd16;
    private chooserDay.Button cmd17;
    private chooserDay.Button cmd18;
    private chooserDay.Button cmd19;
    private chooserDay.Button cmd2;
    private chooserDay.Button cmd20;
    private chooserDay.Button cmd21;
    private chooserDay.Button cmd22;
    private chooserDay.Button cmd23;
    private chooserDay.Button cmd24;
    private chooserDay.Button cmd25;
    private chooserDay.Button cmd26;
    private chooserDay.Button cmd27;
    private chooserDay.Button cmd28;
    private chooserDay.Button cmd29;
    private chooserDay.Button cmd3;
    private chooserDay.Button cmd30;
    private chooserDay.Button cmd31;
    private chooserDay.Button cmd32;
    private chooserDay.Button cmd33;
    private chooserDay.Button cmd34;
    private chooserDay.Button cmd35;
    private chooserDay.Button cmd36;
    private chooserDay.Button cmd37;
    private chooserDay.Button cmd38;
    private chooserDay.Button cmd39;
    private chooserDay.Button cmd4;
    private chooserDay.Button cmd40;
    private chooserDay.Button cmd41;
    private chooserDay.Button cmd42;
    private chooserDay.Button cmd5;
    private chooserDay.Button cmd6;
    private chooserDay.Button cmd7;
    private chooserDay.Button cmd8;
    private chooserDay.Button cmd9;
    private chooserDay.Button cmdFr;
    private chooserDay.Button cmdMo;
    private chooserDay.Button cmdSa;
    private chooserDay.Button cmdSu;
    private chooserDay.Button cmdTh;
    private chooserDay.Button cmdTu;
    private chooserDay.Button cmdWe;
