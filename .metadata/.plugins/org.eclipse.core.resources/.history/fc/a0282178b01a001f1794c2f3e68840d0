...
public class ThuePhong extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		panelRound1Layout.setHorizontalGroup(panelRound1Layout
				...
				.addGroup(panelRound1Layout.createSequentialGroup().addGap(57, 57, 57).addGroup(panelRound1Layout
						...
						.addGroup(panelRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(panelRound1Layout.createSequentialGroup()
										.addComponent(jLabel22, javax.swing.GroupLayout.PREFERRED_SIZE, 77,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addGap(6, 6, 6).addComponent(btnKTSLPhong).addContainerGap(88, Short.MAX_VALUE)));
																...
																.addGroup(panelRound1Layout.createSequentialGroup()
																		...
																		.addGroup(panelRound1Layout.createParallelGroup(
																				...
																				.addComponent(txtSoNguoiLon,
																						...
																						javax.swing.GroupLayout.PREFERRED_SIZE)))
																.addGroup(panelRound1Layout.createSequentialGroup()
																		.addGap(12, 12, 12).addComponent(jLabel23,
																				javax.swing.GroupLayout.PREFERRED_SIZE,
																				19,
																				javax.swing.GroupLayout.PREFERRED_SIZE)))
														.addGap(21, 21, 21)
	...
	private boolean btnKiemTraTrungActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnKiemTraTrungActionPerformed
		...
		if (!kiemTraTrungNgayTra(ngayTra)) {
			...
			return false;
		} else if (ngayTra.isBefore(ngayNhan) || ngayTra.isEqual(ngayNhan)) {
		...
		if (cbKieuThue.getSelectedItem().toString().equals("Qua đêm")) {
			if (ngayTra.minusDays(1).isAfter(ngayNhan)) {
				JOptionPane.showMessageDialog(null, "Thời gian thuê phòng qua đêm chỉ được tối đa là 1 ngày!", "Lỗi",
						JOptionPane.ERROR_MESSAGE);
				return false;
			}
		}
	...
	private boolean btnThuePhongActionPerformed(ActionEvent evt) {// GEN-FIRST:event_btnThuePhongActionPerformed
		...
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss");
		LocalDateTime ngayNhan = LocalDateTime.parse(String.format("%s %s", txtCheckIn.getText(), LocalTime.now().truncatedTo(ChronoUnit.SECONDS)), formatter);
		LocalDateTime ngayTra = LocalDateTime.parse(String.format("%s %s", txtCheckOut.getText(), LocalTime.now().truncatedTo(ChronoUnit.SECONDS)), formatter);
		String loaiPhong = "";
		String kieuThue = "";
		String maLoaiThue = "";
